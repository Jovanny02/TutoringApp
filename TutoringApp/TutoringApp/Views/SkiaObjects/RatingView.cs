...
namespace SkiaRate
{
    public partial class RatingView : SKCanvasView
    {
        ...
        public static readonly BindableProperty isReadOnlyProperty = BindableProperty.Create(nameof(isReadOnly), typeof(bool), typeof(RatingView), false, propertyChanged: isReadOnlyChanged);
        ...
        //added property to allow for a non-editable rating
        ...
        private void PanGestureRecognizer_PanUpdated(object sender, PanUpdatedEventArgs e)
        {
            ...
            if(e.StatusType != GestureStatus.Completed && !this.isReadOnly) 
            {
